...
public class XmlHandler {
     ...
     */
    static List<Song> readXMLToSongs(String filename) throws IOException {
        Songs songs = null;
        ...
        try {
            ...
            songs = (Songs) jaxbUnmarshaller.unmarshal(is);
     ...
     */
    static void writeSongsToXML(List<Song> songs, String filename) throws IOException {
        try {
